...
__all__ = ["FirefoxBookmarksController"]


class FirefoxBookmarksController(AbstractContextManager):
    ...
    def __init__(
        ...
        self.logger = log.getChild("FirefoxBookmarksController")
    ...
    def parse_bookmarks(self) -> dict:
        ...
        try:
            bookmarks_data = firefox.parse_bookmarks(
